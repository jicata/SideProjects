...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        public static extern bool CreateUrlCacheEntry(string lpszUrlName, uint dwExpectedFileSize, string lpszFileExtension,string lpszFileName, int dwReserved = 0);

        [DllImport("wininet.dll", SetLastError = true)]
        public static extern bool CommitUrlCacheEntryW(string lpszUrlName, string lpszLocalFileName, FILETIME ExpireTIme,
            FILETIME LastModifiedTime, int CacheEntryType, string lpHeaderInfo, uint cchHeaderInfo,
...
;
        ...
        static void Main(string[] args)
        {
            ...
            foreach (string actualPathName in myFiles)
            {
                ...
                string destinationFolder = Path.GetDirectoryName(realPath);
                string fileName = "IFTHISWORKS";
                string fileExtension = ".txt";
                var created = CreateUrlCacheEntry(actualPathName, 328, fileExtension, fileName);
